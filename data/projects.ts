...
export const projects: Project[] = [
  ...
  {
    slug: "topsecret-vendas-hub",
    projectKind: "topsecret",
    title: "Vendas Hub — confidencial",
    shortDescription:
      "CRM e funil de vendas em produção: oportunidades, equipe, histórico e dados de clientes — repositório privado, sem exposição pública.",
    detailedDescription:
      "O Vendas Hub é o ponto central da operação comercial do cliente: cadastro de clientes e negócios, registro de etapas do funil, responsáveis e histórico do que foi feito em cada oportunidade. Foi pensado como um sistema de vendas de verdade — não só uma listagem, mas regras de preenchimento, visão por vendedor ou time e leitura rápida do que precisa de atenção. Lida com informação sensível (nomes, contatos, valores, pipeline) e roda com código em repositório privado no GitHub; o dossiê publica só contexto, abordagem e resultado, nunca telas, URLs ou identidade da operação.",
    ...
    featured: false,
    confidential: true,
    stack: ["Web app", "CRM interno", "Dashboard", "API", "HTTPS"],
    context:
      "A operação precisava sair de planilhas e grupos soltos para um cadastro de vendas único, com rastreio de etapas e donos claros por oportunidade — sem permitir vazamento de dados de terceiros.",
    challenges: [
      ...
      "Manter repositório e deploy fora do catálogo aberto, com sigilo comercial do cliente.",
    ],
    solution: [
      ...
      "Case limitado ao que o cliente autorizou: problema, solução e resultado — nada operacional.",
    ],
    results: [
      "Um só lugar para cadastro, histórico e acompanhamento de vendas.",
      "Menos perda de informação entre pessoas e canais.",
      "Prova de entrega em CRM real com repositório privado e dados protegidos.",
    ],
  },
  {
    slug: "topsecret-sistema-https-whatsapp",
    projectKind: "topsecret",
    title: "Sistema HTTPS WhatsApp — confidencial",
    shortDescription:
      "Canal oficial corporativo em infraestrutura própria: número dedicado, bots, filas e integrações HTTPS — código privado, operação sensível.",
    detailedDescription:
      "Este sistema permite usar um número de WhatsApp da empresa de forma controlada e personalizada. Você faz o login do número (como no app) e passa a ter um canal seguro via HTTPS para conectar outras soluções: bots de atendimento, disparo de mensagens, alertas, cadastros e qualquer fluxo que precise falar com o cliente no WhatsApp. A base única alimenta CEPBOT, MS e demais módulos do ecossistema — com regras claras, monitoramento e estabilidade. Tokens, sessões, webhooks e payloads ficam em repositórios privados; o dossiê descreve capacidade técnica sem abrir arquitetura, endpoints ou evidências que comprometam o cliente.",
    thumbnail: "/project-thumbs/sistema-https-whatsapp.svg",
    category: "Infraestrutura WhatsApp",
    year: 2025,
    impactLabel: "Número oficial integrado",
    featured: false,
    confidential: true,
    stack: ["Conexão por número", "HTTPS", "Filas", "Bots", "Integração multi-sistema"],
    context:
    ...
    challenges: [
      ...
      "Proteger tokens, sessões e conteúdo de conversa com código fora do GitHub público.",
    ],
    solution: [
      ...
      "Documentação externa só em nível executivo — identidade e detalhes técnicos redigidos.",
    ],
    results: [
      "Um único ponto de conexão WhatsApp para todo o ecossistema de atendimento e envio.",
      "Mais previsibilidade para escalar automação sem trocar de número ou ferramenta a cada projeto.",
      "Referência para quem precisa do mesmo rigor de sigilo em mensageria e APIs.",
    ],
  },
];
