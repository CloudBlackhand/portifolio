...
const TEASER_STATUS =
  "cloud service · dossies em sigilo · repositorios privados no git";
      ...
      <div className="marathon-teaser-inner">
        ...
        >
          ...
          <p className="marathon-teaser-lead">
            ...
            clientes — repositórios privados no GitHub. Você vê contexto, entrega e
            resultado; telas, credenciais e operação ficam protegidas.
          </p>
